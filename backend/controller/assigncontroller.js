...
const postUploadData=async(req,res)=>{
    upload(req,res,async(error)=>{
       ...
       try{
            await db.query('INSERT INTO uploadedassignment (title,dueDate,comments,filename,data,year,branch) VALUES($1,$2,$3,$4,$5,$6,$7)',[title,dueDate,comments,filename,Data,year,branch])
